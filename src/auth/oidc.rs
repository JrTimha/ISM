...
//!
//! `Default` is derived throughout so `KeycloakAuthInstance::without_discovery` can seed a key set
//! that discovery never filled; it is not meant as a usable configuration.
