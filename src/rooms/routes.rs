...
pub fn create_room_routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/api/rooms/{room_id}/read-states", get(handle_get_read_states))
}
